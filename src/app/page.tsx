    ...
    <div className="min-h-screen bg-black relative scroll-smooth overflow-x-hidden w-full max-w-full">
      ...
      <motion.div 
          ...
          <motion.div 
            ...
            className="py-16 md:py-20 px-4 bg-gradient-to-b from-black via-gray-900 to-black"
          >
            <div className="max-w-4xl mx-auto text-center">
              <motion.div
                ...
                className="bg-gradient-to-br from-[#1E40AF]/20 via-[#3B82F6]/20 to-[#2563EB]/20 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-white/10 shadow-2xl"
              >
                {/* Music Icon */}
                <motion.div
                  initial={{ opacity: 0, y: -20 }}
                ...
                <motion.h2
                  ...
                  className="text-3xl md:text-5xl font-[family-name:var(--font-inter)] font-black text-white mb-4 leading-tight"
                >
                  Live Band <span className="text-[#B6FF00]">Everyday</span>
                </motion.h2>
                ...
                <motion.p
                  ...
                  className="text-xl md:text-2xl text-white/90 font-[family-name:var(--font-inter)] font-semibold mb-6"
                >
                ...
                <motion.p
                  ...
                  className="text-base md:text-lg text-white/80 font-[family-name:var(--font-inter)] mb-8 max-w-2xl mx-auto leading-relaxed"
                >
                  Experience the magic of live music every single day. Our talented bands create an unforgettable atmosphere that makes every visit special.
                </motion.p>
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-[#E4405F] to-[#C13584] text-white px-6 md:px-8 py-3 md:py-4 rounded-xl font-[family-name:var(--font-inter)] font-bold text-base md:text-lg shadow-lg hover:shadow-xl transition-all duration-300 group"
                >
