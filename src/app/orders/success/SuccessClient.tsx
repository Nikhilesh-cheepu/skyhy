  ...
  return (
    <div className="min-h-screen bg-[#020617] pb-24 text-white">
      <div className="mx-auto flex max-w-md flex-col px-4 pt-24">
        <button
          type="button"
          onClick={() => router.push("/packages-menu")}
        ...
        <div className="rounded-3xl border border-white/10 bg-black/60 px-4 pb-5 pt-5 shadow-[0_18px_45px_rgba(15,23,42,0.9)] backdrop-blur-xl">
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.25em] text-white/50">
                Order {isPaid ? "Confirmed" : "Saved"}
              </p>
              <h1 className="text-base font-semibold">Food & Beverages</h1>
            </div>
          </div>
          ...
          <div className="space-y-1.5 text-xs text-white/70">
            ...
            <p className="pt-1 text-[11px] text-emerald-300">
              {isPaid
                ? "Payment received via Razorpay. Our team will confirm your order shortly."
                : "Order saved. No payment required."}
            </p>
          </div>
