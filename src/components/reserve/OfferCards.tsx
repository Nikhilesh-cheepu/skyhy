...
export const OFFERS: Offer[] = [
  { id: 'eat-drink-128', title: 'Eat & Drink Anything @ ₹128', timing: '12 PM – 8 PM' },
  { id: 'flat-30', title: '30% Flat Discount', timing: '12 PM – 10 PM' },
];

/** Parse "6:15 PM" to minutes since midnight. 12 PM = 720, 8 PM = 1200 */
...
/** ₹128 offer is valid 12 PM – 8 PM (i.e. before 8 PM) */
export function is128OfferValid(selectedTime: string): boolean {
  ...
  const end = 20 * 60;   // 8:00 PM (exclusive)
...
export default function OfferCards({ selectedTime, selectedOfferId, onSelect }: OfferCardsProps) {
  const visibleOffers = selectedTime
    ? OFFERS.filter((o) => o.id !== 'eat-drink-128' || is128OfferValid(selectedTime))
    : [];
